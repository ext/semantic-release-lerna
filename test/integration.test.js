  ...
  await t.notThrowsAsync(
    t.context.m.verifyConditions(
      {npmPublish: false},
      {
        cwd,
        env: {},
        options: {publish: ['semantic-release-lerna']},
    ...
    ...(await t.throwsAsync(
      t.context.m.verifyConditions(
        {},
        {
          ...
          env: {},
          options: {
            publish: ['@semantic-release/github', {path: 'semantic-release-lerna', npmPublish, tarballDir, pkgRoot}],
          },
          stdout: t.context.stdout,
          stderr: t.context.stderr,
          logger: t.context.logger,
    ...
    ...(await t.throwsAsync(
      t.context.m.publish(
        {npmPublish, tarballDir, pkgRoot},
        {
          cwd,
          env: {},
          options: {publish: ['@semantic-release/github', 'semantic-release-lerna']},
          nextRelease: {version: '1.0.0'},
          stdout: t.context.stdout,
          stderr: t.context.stderr,
          logger: t.context.logger,
