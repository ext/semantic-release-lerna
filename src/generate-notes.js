...
export async function generateNotes(pluginConfig, context) {
	...
	const [match, auth, host, path] =
		/* eslint-disable-next-line security/detect-unsafe-regex, regexp/no-super-linear-backtracking -- technical debt  */
	...
	/* eslint-disable-next-line security/detect-unsafe-regex, regexp/no-super-linear-backtracking, regexp/no-misleading-capturing-group -- technical debt  */
